# Generated by Django 3.1.12 on 2021-08-06 05:23
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('organization', djongo.models.fields.EmbeddedField(model_container=server.models.organization.Organization, model_form_class=server.models.organization.OrganizationForm)),
            ],
            options={
                'ordering': ['name'],
            },
