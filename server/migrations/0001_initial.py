# Generated by Django 3.1.12 on 2021-08-11 08:25
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('organization', djongo.models.fields.EmbeddedField(model_container=server.models.organization_model.Organization, model_form_class=server.models.organization_model.OrganizationForm)),
            ],
            options={
                'ordering': ['name'],
            },
